...
<%
    ...
    String name="", cat="", price="", desc="", img="";
    String err = request.getParameter("err");
    if (err == null) err = "";

    if ("POST".equalsIgnoreCase(request.getMethod())) {
        // This part won't be hit anymore since action is changed to Servlet
    } else {
...
<div class="container">
    ...
    <form action="EditProductServlet" method="POST" enctype="multipart/form-data">
                ...
                <%
                    try (Connection con = DBConnection.getConnection();
                        ...
                        while(rs.next()){
                            ...
                            String sel = cname.equals(cat) ? "selected" : "";
                            out.print("<option value='"+cname+"' "+sel+">"+cname+"</option>");
                        }
                    } catch(Exception e){}
                %>
            </select>
        ...
        <div class="form-group">
            ...
            <p style="font-size: 12px; color: #f5d48e; margin-top: 5px;">Current: <%= img %></p>
        </div>
        <div class="form-group">
